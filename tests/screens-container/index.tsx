...
const ScreenWrapper: React.FC<{
  ...
  // style={ [styles.absolute, {zIndex: 999}]}
  return (
...
//     <ScreenContainer style={styles.screenContainer}>
//       <Screen activityState={props.activityStateA}>
//         <ScreenA isNativeStack/>
//       </Screen>
//       <Screen activityState={props.activityStateB}>
//         <ScreenB isNativeStack/>
//       </Screen>
//       <Screen activityState={props.activityStateC}>
//         <ScreenC isNativeStack/>
//       </Screen>
//     </ScreenContainer>
//   )
}
...
// export default {
//   displayName: "ScreensContainer",
//   framework: "React",
//   category: "Navigation",
//   title: "ScreensContainer",
//   documentationURL: "https://gitee.com/react-native-oh-library/usage-docs/blob/master/zh-cn/react-native-screens.md",
//   description: "导航栏组件依赖",
//   hideTopTitleBar: true,
//   examples: [
//     {
//       title: "react-native-harmony-screens2",
//       render: function (): any {
//         return <RootView />;
//       },
//     },
